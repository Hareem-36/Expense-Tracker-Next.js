...
export default function ExpenseTracker() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-stone-300 to-pink-50">
      {/* Header section */}
      <br></br><header className="bg-primary text-primary-foreground py-4 px-6 shadow bg-blue-800">
        <div className="flex justify-between items-center">
        <h1 className="text-2xl font-bold ">Expense Tracker</h1>
          <div className="text-2xl font-bold"><br></br><br></br>
      ...
      <main className="flex-1 overflow-y-auto p-8">
        <ul className="space-y-4">
          {expenses.map((expense) => (
            ...
            >
              <div>
               <b><h3 className="text-lg font-medium text-blue-900">{expense.name}</h3></b> 
